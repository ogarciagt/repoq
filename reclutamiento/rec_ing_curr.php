...
<div class="container">
    ...
    <div id="wrap-content" class="span-18 last">
    	...
    	<div id="content" class="span-17 last ">
        	<h3>Subir Currículum Vitae de candidato [NOMBRE DE CANDIDATO]</h3>        	
        	<form class="up_file_eta">
        		<li>Subir Currí­culum:</li> 
        		<input type="file" name="curri_can"><input type="submit"></li><br>        		
        	</form>
        	<div>
				<table class="aprob_deneg">
					<tr>
						<td class="eta_si"><a href="#" onclick="abrir('../reclutamiento/rec-popup/rec_si_curr1.php<?php echo $row['IdRE']; ?>'); return false;">Aprobar Currículum</a></a></td>
						<td class="eta_no"><a href="#" onclick="abrir('../reclutamiento/rec-popup/rec_no_curr1.php<?php echo $row['IdRE']; ?>'); return false;">Denegar Currículum</a></a></td>				
