...
<div class="container">
    ...
    <div id="wrap-content" class="span-18 last">
    	...
    	<div id="content" class="span-17 last ">
        	<h3>Sondeo telefónico de [NOMBRE DE CANDIDATO]</h3>        	
        	<form class="up_file_eta">
        		<li>Subir archivo de sondeo:</li> 
        		<input type="file" name="curri_can"><input type="submit"></li><br>        		
        	</form>
        	<div class="pregunta_et">
        		<p>¿Candidato (a) cumple con requisitos descritos en Score Card?</p>
        	</div>
        	<div>
				<table class="aprob_deneg">					
					<tr>
						<td class="eta_si"><a href="#" onclick="abrir('../reclutamiento/rec-popup/rec_si_son2.php<?php echo $row['IdRE']; ?>'); return false;">S� cumple</a></a></td>
						<td class="eta_no"><a href="#" onclick="abrir('../reclutamiento/rec-popup/rec_no_son2.php<?php echo $row['IdRE']; ?>'); return false;">No cumple</a></a></td>				
        	...
        	<p class="regresa_eta">Regresar a la <a href="../reclutamiento/rec_detalle_plaza.php">pagina principal</a> de la plaza [NOMBRE_DE_PLAZA]</p>
