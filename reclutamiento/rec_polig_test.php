...
<div class="container">
    ...
    <div id="wrap-content" class="span-18 last">
    	...
    	<div id="content" class="span-17 last ">
        	<h3>Prueba de polígrafo, [NOMBRE DE CANDIDATO]</h3>        	
        	<form class="up_file_eta">
        		<li>Subir reporte de polígrafo:</li> 
        	...
        	<div>
				<table class="aprob_deneg">					
					<tr>
						<td class="eta_si"><a href="#" onclick="abrir('../reclutamiento/rec-popup/rec_si_pol5.php<?php echo $row['IdRE']; ?>'); return false;">Sí cumple</a></a></td>
						<td class="eta_no"><a href="#" onclick="abrir('../reclutamiento/rec-popup/rec_no_pol5.php<?php echo $row['IdRE']; ?>'); return false;">No cumple</a></a></td>				
