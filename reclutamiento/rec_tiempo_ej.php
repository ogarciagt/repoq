...
<title>Intranet - Modulo de contrataciÃÂÃÂ³n de personal</title>
...
<div class="container">
    ...
    <div id="wrap-content" class="span-18 last">
    	...
    	<h3>Reporte de tiempo consumido en etapas</h3>
    	<h4 class="total_repo">Tiempo total consumido por ésta plaza: [TIEMPO_EMPLEADO EN HORAS]</h4>
     	<div>
    		<table class="repo_box">   							
					<tr class="repo_header">
						<th>Nombre de la etapa de la plaza [NOMBRE_DE_PLAZA]</th>	
						<th>Tiempo empleado en horas</th>			
					</tr>
					<tr>
    	...
    	<div>
    		<h4 class="total_repo">Detalle tiempo empleado por candidatos según etapas</h4>
