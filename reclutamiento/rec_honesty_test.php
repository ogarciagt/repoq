    ...
    <div id="wrap-content" class="span-18 last">
    	...
    	<div id="content" class="span-17 last ">
        	...
        	<form class="up_file_eta">
        		<li>Subir reporte de Honesty:</li> 
        		<input type="file" name="curri_can"><input type="submit"></li><br>  
        		<li>Subir reporte de Integridad y Valores:</li> 
        		<input type="file" name="curri_can"><input type="submit"></li><br>     		
        	</form>
        	...
        	<div>
				<table class="aprob_deneg">					
					<tr>
						<td class="eta_si"><a href="#" onclick="abrir('../reclutamiento/rec-popup/rec_si_hon4.php<?php echo $row['IdRE']; ?>'); return false;">Sí cumple</a></a></td>
						<td class="eta_no"><a href="#" onclick="abrir('../reclutamiento/rec-popup/rec_no_hon4.php<?php echo $row['IdRE']; ?>'); return false;">No cumple</a></a></td>				
