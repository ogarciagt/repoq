...
<div class="container">
    ...
    <div id="wrap-content" class="span-18 last">
    	...
    	<h3>Reporte de tiempo empleado en etapas</h3>
    	<div class="repor_boxes">
    		<h5>Elija cualquiera de los dos reportes detallados</h5>
    		<table>    			
				<tr>
					<td>Total del tiempo<br> por etapas</td>
					<td>Tiempo empleado <br> por candidato</td>				
				</tr>    		
    		</table>
    	</div>
